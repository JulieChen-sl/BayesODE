...
check_convergence_not0beta_NotEqualLambda<-function(yobsv_missing,n.par,delta_t,n.track)
{
  ...
  repeat
  {
    x.val<-mcmcsample(yobsv_missing,n.par,delta_t,n.track,n,n0,
    ...
    if(MPSRF<1.1||(n>8e+06))
    {
      ...
      #######For simulation#####################################################################        
        ...
        IC_ex<-IC(k=n.par,n=13,f_esti_ex,pd)
