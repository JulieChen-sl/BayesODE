...
check_convergence_0beta_EqualLambda<-function(yobsv_missing,n.par,delta_t,n.track)
{
  ...
  repeat
  {
    x.val<-mcmcsample_beta0_lambdaequal(yobsv_missing,n.par,delta_t,n.track,n,n0,
    ...
    if(MPSRF<1.1||(n>8e+06))
    {
      ...
      IC_ex<-IC(k=n.par-2,n=13,f_esti_ex,pd)
